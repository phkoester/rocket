...
static_assert(std::numeric_limits<unsigned __int128>::max() == MAX128);
...
template <char... CS>
constexpr __int128 operator""_i128() {
  static_assert(StaticI128<CS...>::IS_VALID,
                "Invalid characters or number too large");
  return StaticI128<CS...>::PAYLOAD;
}
